      ...
      var t = { 582: (t2, e2, r2) => {
        ...
        function r2(t3, s2, u2, c2) {
            ...
            var l2 = function(t4, e3, r3) {
              ...
              if (0 === n3.length && (null === i2 || 0 === i2.length)) {
                ...
                if ((null === l3 || l3 === h3) && !(h3 < 0 || h3 > a2)) {
                  ...
                  if ((_ = e3.slice(h3)) === c3) {
                    ...
                    if ((b = u3.slice(0, p2)) === (m = d2.slice(0, p2)))
                      return f(b, u3.slice(p2), d2.slice(p2), c3);
                  }
                }
                if (null === l3 || l3 === s3) {
                  ...
                  if (d2 === u3) {
                    ...
                    if ((y = c3.slice(c3.length - v)) === (A = _.slice(_.length - v)))
                      return f(u3, c3.slice(0, c3.length - v), _.slice(0, _.length - v), y);
                  }
                }
              }
              if (n3.length > 0 && i2 && 0 === i2.length) {
                ...
                if (!(a2 < (p2 = b.length) + (v = y.length))) {
                  ...
                  if (b === m && y === A)
                    return f(b, t4.slice(p2, o2 - v), e3.slice(p2, a2 - v), y);
                }
              }
              return null;
            }(t3, s2, u2);
          ...
          var p = t3.substring(t3.length - h2), g = function(t4, a2) {
            ...
            if (-1 !== l3)
              return s3 = [[1, u3.substring(0, l3)], [0, c3], [1, u3.substring(l3 + c3.length)]], t4.length > a2.length && (s3[0][0] = s3[2][0] = e2), s3;
            if (1 === c3.length)
              return [[e2, t4], [1, a2]];
            var f2 = function(t5, e3) {
              var r3 = t5.length > e3.length ? t5 : e3, n3 = t5.length > e3.length ? e3 : t5;
              if (r3.length < 4 || 2 * n3.length < r3.length)
                return null;
            ...
            return function(t5, r3) {
              for (var i2 = t5.length, o2 = r3.length, a3 = Math.ceil((i2 + o2) / 2), s4 = a3, u4 = 2 * a3, c4 = new Array(u4), l4 = new Array(u4), f3 = 0; f3 < u4; f3++)
                c4[f3] = -1, l4[f3] = -1;
              c4[s4 + 1] = 0, l4[s4 + 1] = 0;
              for (var h4 = i2 - o2, d3 = h4 % 2 != 0, p3 = 0, g3 = 0, _2 = 0, v2 = 0, b2 = 0; b2 < a3; b2++) {
                for (var y = -b2 + p3; y <= b2 - g3; y += 2) {
                  for (var m = s4 + y, A = (S = y === -b2 || y !== b2 && c4[m - 1] < c4[m + 1] ? c4[m + 1] : c4[m - 1] + 1) - y; S < i2 && A < o2 && t5.charAt(S) === r3.charAt(A); )
                    S++, A++;
                  if (c4[m] = S, S > i2)
                    g3 += 2;
                  else if (A > o2)
                    p3 += 2;
                  else if (d3 && (w = s4 + h4 - y) >= 0 && w < u4 && -1 !== l4[w] && S >= (C = i2 - l4[w]))
                    return n2(t5, r3, S, A);
                }
                for (var x = -b2 + _2; x <= b2 - v2; x += 2) {
                  for (var C, w = s4 + x, E = (C = x === -b2 || x !== b2 && l4[w - 1] < l4[w + 1] ? l4[w + 1] : l4[w - 1] + 1) - x; C < i2 && E < o2 && t5.charAt(i2 - C - 1) === r3.charAt(o2 - E - 1); )
                    C++, E++;
                  if (l4[w] = C, C > i2)
                    v2 += 2;
                  else if (E > o2)
        ...
        function i(t3, e3) {
          if (!t3 || !e3 || t3.charAt(0) !== e3.charAt(0))
            return 0;
          for (var r3 = 0, n3 = Math.min(t3.length, e3.length), i2 = n3, o2 = 0; r3 < i2; )
            t3.substring(o2, i2) == e3.substring(o2, i2) ? o2 = r3 = i2 : n3 = i2, i2 = Math.floor((n3 - r3) / 2 + r3);
        ...
        function o(t3, e3) {
          if (!t3 || !e3 || t3.slice(-1) !== e3.slice(-1))
            return 0;
          for (var r3 = 0, n3 = Math.min(t3.length, e3.length), i2 = n3, o2 = 0; r3 < i2; )
            t3.substring(t3.length - i2, t3.length - o2) == e3.substring(e3.length - i2, e3.length - o2) ? o2 = r3 = i2 : n3 = i2, i2 = Math.floor((n3 - r3) / 2 + r3);
          return u(t3.charCodeAt(t3.length - i2)) && i2--, i2;
        }
        function a(t3, r3) {
          t3.push([0, ""]);
          for (var n3, s2 = 0, u2 = 0, f2 = 0, h2 = "", d = ""; s2 < t3.length; )
          ...
          var b = false;
          for (s2 = 1; s2 < t3.length - 1; )
            0 === t3[s2 - 1][0] && 0 === t3[s2 + 1][0] && (t3[s2][1].substring(t3[s2][1].length - t3[s2 - 1][1].length) === t3[s2 - 1][1] ? (t3[s2][1] = t3[s2 - 1][1] + t3[s2][1].substring(0, t3[s2][1].length - t3[s2 - 1][1].length), t3[s2 + 1][1] = t3[s2 - 1][1] + t3[s2 + 1][1], t3.splice(s2 - 1, 1), b = true) : t3[s2][1].substring(0, t3[s2 + 1][1].length) == t3[s2 + 1][1] && (t3[s2 - 1][1] += t3[s2 + 1][1], t3[s2][1] = t3[s2][1].substring(t3[s2 + 1][1].length) + t3[s2 + 1][1], t3.splice(s2 + 1, 1), b = true)), s2++;
          b && a(t3, r3);
        }
        function s(t3) {
        ...
        function f(t3, r3, n3, i2) {
          return l(t3) || c(i2) ? null : function(t4) {
            for (var e3 = [], r4 = 0; r4 < t4.length; r4++)
              t4[r4][1].length > 0 && e3.push(t4[r4]);
            return e3;
        ...
        function H(t3, e3, r3, n3) {
          ...
          for (n3 && o2 && (r3 = t3[++i2]); ++i2 < o2; )
            r3 = e3(r3, t3[i2], i2, t3);
          return r3;
        }
        function U(t3) {
          var e3 = false;
        ...
        function Tt(t3, e3, r3, n3, i2, d2, b2) {
          var k2;
          if (n3 && (k2 = d2 ? n3(t3, i2, d2, b2) : n3(t3)), void 0 !== k2)
            return k2;
          if (!Wt(t3))
            return t3;
          var T2 = Ut(t3);
          ...
          if (D2)
            return D2;
          if (b2.set(t3, k2), !T2)
            var F2 = r3 ? function(t4) {
              return function(t5, e4, r4) {
                var n4 = e4(t5);
                return Ut(t5) ? n4 : function(t6, e5) {
                  for (var r5 = -1, n5 = e5.length, i3 = t6.length; ++r5 < n5; )
                    t6[i3 + r5] = e5[r5];
                  return t6;
                }(n4, r4(t5));
              }(t4, Xt, Ft);
        ...
        function Xt(t3) {
          return Gt(t3) ? function(t4, e3) {
            var r3 = Ut(t4) || function(t5) {
              ...
              for (var r4 = -1, n4 = Array(t5); ++r4 < t5; )
                n4[r4] = e4(r4);
              return n4;
            }(t4.length, String) : [], n3 = r3.length, i2 = !!n3;
            for (var a2 in t4)
              !e3 && !tt.call(t4, a2) || i2 && ("length" == a2 || Pt(a2, n3)) || r3.push(a2);
            return r3;
          }(t3) : function(t4) {
            if (!Bt(t4))
              return ht(t4);
            var e3 = [];
            for (var r3 in Object(t4))
              tt.call(t4, r3) && "constructor" != r3 && e3.push(r3);
            return e3;
          }(t3);
        }
        t2.exports = function(t3) {
        ...
        function R(t3, e3) {
          for (var r3 = -1, n3 = null == t3 ? 0 : t3.length; ++r3 < n3; )
            if (e3(t3[r3], r3, t3))
              return true;
          return false;
        }
        ...
        function yt(t3) {
          var e3 = -1, r3 = null == t3 ? 0 : t3.length;
          for (this.__data__ = new bt(); ++e3 < r3; )
            this.add(t3[e3]);
        }
        function mt(t3) {
        ...
        function wt(t3, e3, r3, n3, i2) {
          return t3 === e3 || (null == t3 || null == e3 || !Bt(t3) && !Bt(e3) ? t3 != t3 && e3 != e3 : function(t4, e4, r4, n4, i3, l2) {
            ...
            if (E2 && !C2)
              return l2 || (l2 = new mt()), p2 || zt(t4) ? Et(t4, e4, r4, n4, i3, l2) : function(t5, e5, r5, n5, i4, o2, a2) {
                switch (r5) {
                  case m:
            ...
            return !!E2 && (l2 || (l2 = new mt()), function(t5, e5, r5, n5, i4, o2) {
              ...
              if (u2 != St(e5).length && !a2)
                return false;
              for (var c2 = u2; c2--; ) {
                var l3 = s2[c2];
                if (!(a2 ? l3 in e5 : G.call(e5, l3)))
                  return false;
              }
              var f2 = o2.get(t5);
              if (f2 && o2.get(e5))
              ...
              for (var d2 = a2; ++c2 < u2; ) {
                ...
                if (n5)
                  var _2 = a2 ? n5(g2, p3, l3, e5, t5, o2) : n5(p3, g2, l3, t5, e5, o2);
        ...
        function Et(t3, e3, r3, n3, i2, o2) {
          ...
          for (o2.set(t3, e3), o2.set(e3, t3); ++l2 < s2; ) {
            ...
            if (n3)
              var g2 = a2 ? n3(p2, d2, l2, e3, t3, o2) : n3(d2, p2, l2, t3, e3, o2);
            if (void 0 !== g2) {
              if (g2)
                continue;
              f2 = false;
            ...
            if (h2) {
              if (!R(e3, function(t4, e4) {
                if (a3 = e4, !h2.has(a3) && (d2 === t4 || i2(d2, t4, r3, n3, o2)))
                  return h2.push(e4);
                var a3;
              })) {
                f2 = false;
        ...
        function St(t3) {
          return function(t4, e3, r3) {
            ...
            return qt(t4) ? n3 : function(t5, e4) {
              for (var r4 = -1, n4 = e4.length, i2 = t5.length; ++r4 < n4; )
                t5[i2 + r4] = e4[r4];
              return t5;
            }(n3, r3(t4));
          }(t3, Ht, jt);
        ...
        function Ht(t3) {
          return null != (e3 = t3) && It(e3.length) && !Ft(e3) ? function(t4, e4) {
            ...
            for (var c2 in t4)
              !e4 && !G.call(t4, c2) || a2 && ("length" == c2 || i2 && ("offset" == c2 || "parent" == c2) || o2 && ("buffer" == c2 || "byteLength" == c2 || "byteOffset" == c2) || kt(c2, u2)) || s2.push(c2);
            return s2;
          }(t3) : function(t4) {
            if (r3 = (e4 = t4) && e4.constructor, e4 !== ("function" == typeof r3 && r3.prototype || z))
              return rt(t4);
            var e4, r3, n3 = [];
            for (var i2 in Object(t4))
              G.call(t4, i2) && "constructor" != i2 && n3.push(i2);
            return n3;
          }(t3);
          var e3;
        }
        ...
        !function(t3) {
          t3.compose = function(t4, e3, r3) {
            ...
            for (var i2 in r3 || (n3 = Object.keys(n3).reduce(function(t5, e4) {
              ...
              void 0 !== t4[i2] && void 0 === e3[i2] && (n3[i2] = t4[i2]);
            ...
            if (void 0 === r3 && (r3 = false), "object" != typeof t4)
              return e3;
            if ("object" == typeof e3) {
              if (!r3)
                return e3;
        ...
        var n2 = this && this.__importDefault || function(t3) {
          ...
          return t3.prototype.insert = function(t4, e3) {
            ...
            if (t4 = o.default(t4), "object" == typeof r3) {
              if ("number" == typeof t4.delete && "number" == typeof r3.delete)
                return this.ops[e3 - 1] = { delete: r3.delete + t4.delete }, this;
              if ("number" == typeof r3.delete && null != t4.insert && (e3 -= 1, "object" != typeof (r3 = this.ops[e3 - 1])))
                return this.ops.unshift(t4), this;
              if (a.default(t4.attributes, r3.attributes)) {
                if ("string" == typeof t4.insert && "string" == typeof r3.insert)
                  return this.ops[e3 - 1] = { insert: r3.insert + t4.insert }, "object" == typeof t4.attributes && (this.ops[e3 - 1].attributes = t4.attributes), this;
                if ("number" == typeof t4.retain && "number" == typeof r3.retain)
                  return this.ops[e3 - 1] = { retain: r3.retain + t4.retain }, "object" == typeof t4.attributes && (this.ops[e3 - 1].attributes = t4.attributes), this;
              }
            }
            ...
            if (null != o2 && "number" == typeof o2.retain && null == o2.attributes) {
              for (var c2 = o2.retain; "insert" === r3.peekType() && r3.peekLength() <= c2; )
                c2 -= r3.peekLength(), i2.push(r3.next());
              o2.retain - c2 > 0 && n3.next(o2.retain - c2);
            }
            for (var l2 = new t3(i2); r3.hasNext() || n3.hasNext(); )
              if ("insert" === n3.peekType())
                l2.push(n3.next());
              else if ("delete" === r3.peekType())
                l2.push(r3.next());
              else {
                ...
                if ("number" == typeof d.retain) {
                  ...
                  "number" == typeof d.delete && "number" == typeof h.retain && l2.push(d);
              }
            return l2.chop();
            ...
            var n3 = [this, e3].map(function(t4) {
              return t4.map(function(r4) {
                if (null != r4.insert)
                  return "string" == typeof r4.insert ? r4.insert : c;
            ...
            for (var n3 = u.default.iterator(this.ops), i2 = new t3(), o2 = 0; n3.hasNext(); ) {
              ...
              if (c2 < 0)
                ...
                if (false === e3(i2, n3.next(1).attributes || {}, o2))
                  return;
                o2 += 1, i2 = new t3();
              }
            }
            ...
            return this.reduce(function(t4, n3) {
              if (n3.insert)
                r3.delete(u.default.length(n3));
              else {
                if (n3.retain && null == n3.attributes)
                  return r3.retain(n3.retain), t4 + n3.retain;
            ...
            if (void 0 === r3 && (r3 = false), r3 = !!r3, "number" == typeof e3)
              return this.transformPosition(e3, r3);
            for (var n3 = e3, i2 = u.default.iterator(this.ops), o2 = u.default.iterator(n3.ops), a2 = new t3(); i2.hasNext() || o2.hasNext(); )
              if ("insert" !== i2.peekType() || !r3 && "insert" === o2.peekType())
                if ("insert" === o2.peekType())
                  a2.push(o2.next());
                else {
                ...
                a2.retain(u.default.length(i2.next()));
            return a2.chop();
        ...
        var i = n2(r2(430)), o = function() {
          ...
          return t3.prototype.hasNext = function() {
            ...
            if (e3) {
              ...
              if (t4 >= n3 - r3 ? (t4 = n3 - r3, this.index += 1, this.offset = 0) : this.offset += t4, "number" == typeof e3.delete)
                return { delete: t4 };
              var o2 = {};
        ...
        void 0 === (i = "function" == typeof (n2 = function() {
          ...
          function n3(t4) {
            ...
            if (screen.deviceXDPI === screen.logicalXDPI)
              return t4;
            if ("length" in t4)
              return Array.prototype.map.call(t4, n3);
          ...
          function i2(t4, e4) {
            var r4, n4 = 0, i3 = 1024;
            if (i3 >= e4.length)
              return Array.prototype.push.apply(t4, e4);
            for (; n4 < e4.length; )
              r4 = Array.prototype.push.apply(t4, Array.prototype.slice.call(e4, n4, n4 + i3)), n4 += i3;
            return r4;
          }
          return e3.isBroken = function() {
            ...
            if (e4.ieZoom)
              return n3(t4.getClientRects());
            if (!e4.getClientRects)
              return t4.getClientRects();
            var r4 = [], o = [], a = t4.endContainer, s = t4.endOffset, u = document.createRange();
            function c(t5) {
              for (var e5 = 0; t5 = t5.previousSibling; )
                e5++;
              return e5;
            }
            for (; a !== t4.commonAncestorContainer; )
              u.setStart(a, 0), u.setEnd(a, s), i2(o, u.getClientRects()), s = c(a), a = a.parentNode;
        ...
        var n2 = function() {
          ...
          function t3() {
            this.connected_ = false, this.mutationEventsAdded_ = false, this.mutationsObserver_ = null, this.observers_ = [], this.onTransitionEnd_ = this.onTransitionEnd_.bind(this), this.refresh = function(t4, e3) {
              ...
              function u2() {
                ...
                if (r3) {
                  ...
                  r3 = true, n3 = false, setTimeout(s2, 20);
                i2 = t5;
              }
              return u2;
        ...
        var b = function() {
          ...
          function t3(t4, e3, r3) {
            if (this.activeObservations_ = [], this.observations_ = new n2(), "function" != typeof t4)
        ...
        var e2 = [];
        function r2(t3) {
          for (var r3 = -1, n3 = 0; n3 < e2.length; n3++)
            if (e2[n3].identifier === t3) {
              r3 = n3;
              break;
            }
          return r3;
        ...
        function n2(t3, n3) {
          for (var o = {}, a = [], s = 0; s < t3.length; s++) {
            ...
            if (-1 !== h)
              e2[h].references++, e2[h].updater(d);
            else {
              var p = i(d, n3);
          ...
          return t3.prototype.createCursor = function(t4, e3, r3) {
            ...
            if (!this._isObserving) {
              var e3 = this.quill.container.getElementsByClassName("ql-editor")[0], r3 = new l.default(function(e4) {
                if (!e4[0].target.isConnected)
                  return r3.disconnect(), void (t4._isObserving = false);
                t4.update();
              });
              r3.observe(e3), this._isObserving = true;
            }
          }, t3.prototype._updateCursor = function(t4) {
            if (this._registerResizeObserver(), !t4.range)
              return t4.hide();
            ...
            if (!this._leafIsValid(n3) || !this._leafIsValid(i2))
              return t4.hide();
            t4.show();
        ...
        t2.exports = function() {
          ...
          function r2(n3, i2) {
            ...
            var o2 = function(r3) {
              ...
              return "string" == typeof r3 && (r3 = function(r4) {
                ...
                if (t4 = x(t4, 360), e3 = x(e3, 100), r4 = x(r4, 100), 0 === e3)
                  n5 = i4 = o4 = r4;
                else {
          ...
          function g(t4, e3) {
            ...
            for (var n3 = r2(t4).toHsl(), i2 = [r2(t4)], o2 = 360 / e3, a2 = 1; a2 < e3; a2++)
              i2.push(r2({ h: (n3.h + a2 * o2) % 360, s: n3.s, l: n3.l }));
            return i2;
          }
          function _(t4) {
          ...
          function v(t4, e3, n3) {
            ...
            for (i2.h = (i2.h - (o2 * e3 >> 1) + 720) % 360; --e3; )
              i2.h = (i2.h + o2) % 360, a2.push(r2(i2));
            return a2;
          }
          function b(t4, e3) {
            e3 = e3 || 6;
            for (var n3 = r2(t4).toHsv(), i2 = n3.h, o2 = n3.s, a2 = n3.v, s2 = [], u2 = 1 / e3; e3--; )
              s2.push(r2({ h: i2, s: o2, v: a2 })), a2 = (a2 + u2) % 1;
            return s2;
          }
          r2.prototype = { isDark: function() {
            ...
            if ("object" == typeof t4) {
              var n3 = {};
              for (var i2 in t4)
                t4.hasOwnProperty(i2) && (n3[i2] = "a" === i2 ? t4[i2] : S(t4[i2]));
              t4 = n3;
            }
            return r2(t4, e3);
            ...
            for (var l2 = 0; l2 < e3.length; l2++)
              (i2 = r2.readability(t4, e3[l2])) > c2 && (c2 = i2, u2 = r2(e3[l2]));
          ...
          var y = r2.names = { aliceblue: "f0f8ff", antiquewhite: "faebd7", aqua: "0ff", aquamarine: "7fffd4", azure: "f0ffff", beige: "f5f5dc", bisque: "ffe4c4", black: "000", blanchedalmond: "ffebcd", blue: "00f", blueviolet: "8a2be2", brown: "a52a2a", burlywood: "deb887", burntsienna: "ea7e5d", cadetblue: "5f9ea0", chartreuse: "7fff00", chocolate: "d2691e", coral: "ff7f50", cornflowerblue: "6495ed", cornsilk: "fff8dc", crimson: "dc143c", cyan: "0ff", darkblue: "00008b", darkcyan: "008b8b", darkgoldenrod: "b8860b", darkgray: "a9a9a9", darkgreen: "006400", darkgrey: "a9a9a9", darkkhaki: "bdb76b", darkmagenta: "8b008b", darkolivegreen: "556b2f", darkorange: "ff8c00", darkorchid: "9932cc", darkred: "8b0000", darksalmon: "e9967a", darkseagreen: "8fbc8f", darkslateblue: "483d8b", darkslategray: "2f4f4f", darkslategrey: "2f4f4f", darkturquoise: "00ced1", darkviolet: "9400d3", deeppink: "ff1493", deepskyblue: "00bfff", dimgray: "696969", dimgrey: "696969", dodgerblue: "1e90ff", firebrick: "b22222", floralwhite: "fffaf0", forestgreen: "228b22", fuchsia: "f0f", gainsboro: "dcdcdc", ghostwhite: "f8f8ff", gold: "ffd700", goldenrod: "daa520", gray: "808080", green: "008000", greenyellow: "adff2f", grey: "808080", honeydew: "f0fff0", hotpink: "ff69b4", indianred: "cd5c5c", indigo: "4b0082", ivory: "fffff0", khaki: "f0e68c", lavender: "e6e6fa", lavenderblush: "fff0f5", lawngreen: "7cfc00", lemonchiffon: "fffacd", lightblue: "add8e6", lightcoral: "f08080", lightcyan: "e0ffff", lightgoldenrodyellow: "fafad2", lightgray: "d3d3d3", lightgreen: "90ee90", lightgrey: "d3d3d3", lightpink: "ffb6c1", lightsalmon: "ffa07a", lightseagreen: "20b2aa", lightskyblue: "87cefa", lightslategray: "789", lightslategrey: "789", lightsteelblue: "b0c4de", lightyellow: "ffffe0", lime: "0f0", limegreen: "32cd32", linen: "faf0e6", magenta: "f0f", maroon: "800000", mediumaquamarine: "66cdaa", mediumblue: "0000cd", mediumorchid: "ba55d3", mediumpurple: "9370db", mediumseagreen: "3cb371", mediumslateblue: "7b68ee", mediumspringgreen: "00fa9a", mediumturquoise: "48d1cc", mediumvioletred: "c71585", midnightblue: "191970", mintcream: "f5fffa", mistyrose: "ffe4e1", moccasin: "ffe4b5", navajowhite: "ffdead", navy: "000080", oldlace: "fdf5e6", olive: "808000", olivedrab: "6b8e23", orange: "ffa500", orangered: "ff4500", orchid: "da70d6", palegoldenrod: "eee8aa", palegreen: "98fb98", paleturquoise: "afeeee", palevioletred: "db7093", papayawhip: "ffefd5", peachpuff: "ffdab9", peru: "cd853f", pink: "ffc0cb", plum: "dda0dd", powderblue: "b0e0e6", purple: "800080", rebeccapurple: "663399", red: "f00", rosybrown: "bc8f8f", royalblue: "4169e1", saddlebrown: "8b4513", salmon: "fa8072", sandybrown: "f4a460", seagreen: "2e8b57", seashell: "fff5ee", sienna: "a0522d", silver: "c0c0c0", skyblue: "87ceeb", slateblue: "6a5acd", slategray: "708090", slategrey: "708090", snow: "fffafa", springgreen: "00ff7f", steelblue: "4682b4", tan: "d2b48c", teal: "008080", thistle: "d8bfd8", tomato: "ff6347", turquoise: "40e0d0", violet: "ee82ee", wheat: "f5deb3", white: "fff", whitesmoke: "f5f5f5", yellow: "ff0", yellowgreen: "9acd32" }, m = r2.hexNames = function(t4) {
            var e3 = {};
            for (var r3 in t4)
              t4.hasOwnProperty(r3) && (e3[t4[r3]] = r3);
            return e3;
          }(y);
          function A(t4) {
